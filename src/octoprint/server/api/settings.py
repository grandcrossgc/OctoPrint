...
def getSettings():
	...
	data = {
		...
		"serial": {
			...
			"flowControlOptions": connectionOptions["flowControls"],
...
def _saveSettings(data):
	...
	if "serial" in data.keys():
		...
		if "flowControl" in data["serial"] and data["serial"]["flowControl"] in ("None", "Software", "Hardware"): s.set(["serial", "flowControl"], data["serial"]["flowControl"])
